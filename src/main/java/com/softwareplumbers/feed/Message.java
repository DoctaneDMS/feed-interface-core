...
public interface Message {
     ...
     * @throws IOException 
     */
    public <T> T writeData(OutputStream os, ErrorHandler<T> errorCallback) throws StreamingException;
     ...
     * @throws IOException 
     */
    public default void writeData(OutputStream os) throws StreamingException {
        writeData(os, (e,is)->{ throw new StreamingException(e); });
    }
